...
$timesArray=['Pain Gaming','FURIA','Rensga','LOUD','INTZ','Cloud9','Team Liquid','Equipe do Flamengo' ,'Kabum' , 'Netshoes Miners' ,'Red Canids','Vorax Libert','Isurus','Misfits','Mad Lions'];
...
$playersArray=['Betão da FURIA Academy','Ranger Ex-Flamengo','Tinows da Pain Gaming','Brtt da Pain Gaming','Mewkyo da LOUD','Damage da Rensga','RedBert do Flamengo','Netuno do Flamengo','Robo da Pain Gaming' ,'Kiari' ,'Trigo Ex-Rensga','Pobelter da CLG','Anyyy da FURIA','Titan da Red Canids','Shrimp Ex-Flamengo','Luci da Pain','Tutz do Flamengo','Parang do Flamengo','Cariok da Pain','Jean Mago do Flamengo Academy','Professor da INTZ','Micao da INTZ','Evrot da Kabum','Tay da LOUD','DudsTheBoy da LOUD','fnb da Vorax','Matsukaze da Vorax','Wos da Vorax'];
